...
def multi_type_ds():
    ...
    return xr.Dataset(
        {
            'i8_var': xr.DataArray(np.array([[-1, 0], [1, 2]], dtype='int8'), dims=['y', 'x']),
            ...
            'i32_var': xr.DataArray(
                np.array([[100000, -100000], [200000, -200000]], dtype='int32'), dims=['y', 'x']
            ),
            'u32_var': xr.DataArray(
                np.array([[3_000_000_000, 0], [1, 4_000_000_000]], dtype='uint32'), dims=['y', 'x']
            ),
            'i64_var': xr.DataArray(
                np.array([[1_000_000_000_000, -1], [0, 42]], dtype='int64'), dims=['y', 'x']
            ),
            'str_var': xr.DataArray(
                np.array([['hello', 'world'], ['foo', 'bar']], dtype=object), dims=['y', 'x']
            ),
            'bool_var': xr.DataArray(np.array([[True, False], [False, True]]), dims=['y', 'x']),
        },
        coords={
